...
export default async function DashboardWrapper({ downloadResume = false }: Readonly<{ downloadResume: boolean }>) {
	return (
		<main>
			...
			<div className="w-full flex flex-col md:flex-row md:gap-x-20">
				...
				<div className="mt-4 flex flex-col gap-y-3 text-justify font-semibold text-lg">
					...
					<p className="text-justify font-semibold text-lg">
						<span className="font-extrabold">ZentrumHub</span> - A Bootstrapped Startup revolutionizing the OTA (Online Travel Agency) Industry, Giving direct competition to big players like Booking.com, MakeMyTrip and recently recognized as the Hot
						25 Startup!
					</p>
			...
			<div className="w-full mt-5 flex flex-col gap-y-3 text-justify font-semibold text-lg">
				...
				<p>
					{" "}
					<span className="font-bold text-xl">&bull;Next.js</span> - With Next.js 15, you don&apos;t need to be an expert to make an highly optimizes and SEO friendly app, it offers everything you need out of the box! After all, this website is also
					made using Next.js!
				</p>
			...
			<DownloadResume downloadResume={downloadResume}/>
		</main>
	);
}
